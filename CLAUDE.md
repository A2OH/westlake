...
- Source: `$HOME/aosp-android-11/frameworks/base/core/java/android/`
...
| Build ART A11 (x86-64) | `cd $HOME/art-universal-build && make -j8 link link-runtime` |
| Build ART A11 (OHOS ARM64) | `make -f Makefile.ohos-arm64 -j8 link-runtime` |
| Build ART A15 (x86-64) | `cd $HOME/art-latest && make -j8 link link-runtime` |
...
| ART A11 dex2oat (x86_64) | `$HOME/art-universal-build/build/bin/dex2oat` |
| ART A11 dalvikvm (x86_64) | `$HOME/art-universal-build/build/bin/dalvikvm` |
| ART A15 dex2oat (x86_64) | `$HOME/art-latest/build/bin/dex2oat` |
| ART A15 dalvikvm (x86_64) | `$HOME/art-latest/build/bin/dalvikvm` |
| ART A15 core JARs | `$HOME/art-latest/core-jars/` |
