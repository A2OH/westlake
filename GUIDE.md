...
|------|---------|-----------------|
| AOSP Android 11 source | Provides `android.jar`, `aapt`, `dx`, `apksigner` | Pre-downloaded at `$HOME/aosp-android-11/` |
...
DX_JAR=$HOME/aosp-android-11/prebuilts/sdk/tools/lib/dx.jar
APKSIGNER=$HOME/aosp-android-11/prebuilts/sdk/tools/linux/bin/apksigner
