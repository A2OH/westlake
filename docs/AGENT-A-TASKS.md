...
Source binary: `$HOME/art-universal-build/build-ohos-arm64/bin/dalvikvm` (11MB ARM64 static)
...
| What | Path |
|------|------|
| ARM64 dalvikvm (NEW) | `$HOME/art-universal-build/build-ohos-arm64/bin/dalvikvm` |
