# Android 11 (API 30) Public API Enumeration: Android Content
...
- **Implements:** `java.lang.Cloneable java.lang.Comparable<android.content.ComponentName> android.os.Parcelable`
...
- **Extends:** `java.util.Iterator<android.content.Entity>`
...
- **Implements:** `java.lang.Comparable<android.content.res.Configuration> android.os.Parcelable`
...
- **Implements:** `java.lang.Iterable<android.database.CursorJoiner.Result> java.util.Iterator<android.database.CursorJoiner.Result>`
...
- **Extends:** `android.database.Observable<android.database.DataSetObserver>`
