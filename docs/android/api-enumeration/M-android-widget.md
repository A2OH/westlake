...
- **Implements:** `android.widget.Filter.FilterListener android.text.TextWatcher android.view.ViewTreeObserver.OnGlobalLayoutListener android.view.ViewTreeObserver.OnTouchModeChangeListener`
...
- **Annotations:** `@Deprecated @android.widget.RemoteViews.RemoteView`
...
- **Extends:** `android.widget.Adapter> extends android.view.ViewGroup`
