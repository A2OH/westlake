...
- Local mirror: `$HOME/android-to-openharmony-migration/artifacts/v3-w3-requirements/`
...
Evidence sources:
- noice imports in `$HOME/android-to-openharmony-migration/westlake-host-gradle/app/src/main/java/com/westlake/host/NoiceInProcessActivity.kt`
...
- McD AndroidManifest: `$HOME/android-to-openharmony-migration/artifacts/real-mcd/apktool_decoded/AndroidManifest.xml`
