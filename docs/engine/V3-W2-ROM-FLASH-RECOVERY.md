...
```powershell
scp -P [REDACTED-PORT] -r [REDACTED]@[REDACTED-IP]:/data/share/rk3568/images           D:\rk3568\
scp -P [REDACTED-PORT] -r [REDACTED]@[REDACTED-IP]:/data/share/rk3568/RKDevTool_v3.30_for_window  D:\rk3568\
scp -P [REDACTED-PORT] -r [REDACTED]@[REDACTED-IP]:/data/share/rk3568/DriverAssitant_v5.1.1       D:\rk3568\
```

Credentials: user `yue.chen`, password `***REMOVED***`, port `[REDACTED-PORT]`
...
| Pull images from GZ02 via `scp -P [REDACTED-PORT]` | §3.1 step 1 (line 107-112) |
