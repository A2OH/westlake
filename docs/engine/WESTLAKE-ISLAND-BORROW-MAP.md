...
Status: READ-ONLY analysis; Island tree is owned by GZ02 user's team.
...
1. **I have NOT run Island locally.** All claims about Island runtime
   ...
   `STACK-INTERFACES-AND-CONTAINER-COMPARISON.md` user authored.
...
7. **I did not investigate user's team / IP licensing.** START-HERE.md
