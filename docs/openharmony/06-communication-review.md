# Communication and Networking Subsystem - Code Review
...
- `$HOME/openharmony/foundation/communication/` (netstack, wifi, bluetooth, nfc, dsoftbus)
- `$HOME/openharmony/base/telephony/` (call_manager, cellular_call, sms_mms, core_service)
...
**Severity:** CRITICAL
**Files:**
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/http/http_exec/src/http_exec.cpp` (lines 774-775)
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/fetch/fetch_exec/src/fetch_exec.cpp` (lines 274-275)
- `$HOME/openharmony/foundation/communication/netstack/frameworks/native/http/http_client/http_client_task.cpp` (lines 174-175)
...
**Severity:** CRITICAL
**Files:**
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp` (line 573)
- `$HOME/openharmony/foundation/communication/netstack/frameworks/native/websocket_client/websocket_client.cpp` (line 373)
...
**Severity:** HIGH
**Files:**
- `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/wifi_auth_center.cpp` (lines 30-34)
- `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/BUILD.gn` (line 107)
- `$HOME/openharmony/foundation/communication/wifi/wifi/wifi_lite.gni` (line 27)
...
**Severity:** HIGH
**File:** `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/common/wifi_permission_utils.cpp` (lines 23-87)
...
**Severity:** HIGH
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/tlssocket_exec.cpp` (multiple lines)
...
**Severity:** HIGH
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/tlssocket_exec.cpp` (lines 230-239)
...
**Severity:** HIGH
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp` (line 181)
...
**Severity:** MEDIUM
**File:** `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/wifi_sta/sta_state_machine.cpp` (lines 48-49)
...
**Severity:** MEDIUM
**Files:**
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp` (line 670)
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/http/http_exec/src/http_exec.cpp` (line 188)
- `$HOME/openharmony/foundation/communication/netstack/frameworks/native/tls_socket/src/tls_socket.cpp` (line 410)
...
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/builtin/BUILD.gn` (line 47)
...
**Severity:** MEDIUM
**File:** `$HOME/openharmony/foundation/communication/dsoftbus/core/authentication/src/auth_session_message.c`
...
**Severity:** MEDIUM
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp`
...
**Severity:** LOW
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/context/tls_connect_context.cpp` (lines 159-169)
...
**Severity:** LOW
**File:** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/tlssocket_exec.cpp` (lines 35-36)
...
**Severity:** LOW
**File:** `$HOME/openharmony/foundation/communication/bluetooth/frameworks/js/napi/src/ble/napi_bluetooth_ble.cpp` (lines 105-131)
...
| # | Finding | Severity | Category | Component |
|---|---------|----------|----------|-----------|
