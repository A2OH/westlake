# Bionic C Library and NDK -- Code Review Report
...
Key source paths:
- `$HOME/aosp-android-11/bionic/libc/bionic/` -- Core C library implementations
- `$HOME/aosp-android-11/bionic/libc/include/` -- Public header files
- `$HOME/aosp-android-11/bionic/libc/kernel/` -- Scrubbed kernel UAPI headers
- `$HOME/aosp-android-11/bionic/libc/arch-arm/`, `arch-arm64/`, `arch-x86/`, `arch-x86_64/` -- Architecture-specific code
- `$HOME/aosp-android-11/bionic/libc/upstream-freebsd/`, `upstream-netbsd/`, `upstream-openbsd/` -- BSD-origin code

### 2.2 Key Differences from glibc/musl

| Feature | Bionic | glibc | musl |
|---------|--------|-------|------|
...
**Key file:** `$HOME/aosp-android-11/bionic/linker/linker_main.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/linker/linker_namespaces.h`
...
**Key file:** `$HOME/aosp-android-11/bionic/linker/dlfcn.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/linker/linker.cpp` (line ~192)
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/SYSCALLS.TXT`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/vdso.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/pthread_create.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/pthread_mutex.cpp`
...
**Key files:**
- `$HOME/aosp-android-11/bionic/libc/bionic/bionic_elf_tls.cpp`
- `$HOME/aosp-android-11/bionic/libc/private/bionic_tls.h`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/malloc_common.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/Android.bp` (lines 94-120)
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/gwp_asan_wrappers.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/malloc_tagged_pointers.h`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/heap_tagging.cpp`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/include/android/versioning.h`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/libc.map.txt`
...
**Key directory:** `$HOME/aosp-android-11/bionic/libc/include/`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/include/dlfcn.h`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/__stack_chk_fail.cpp`
...
**Key files:** `$HOME/aosp-android-11/bionic/libc/include/bits/fortify/string.h` and sibling headers
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/pthread_create.cpp` (lines 109-133)
...
**Key file:** `$HOME/aosp-android-11/bionic/linker/linker_cfi.h`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/seccomp/seccomp_policy.cpp`
...
- `$HOME/aosp-android-11/bionic/libc/SECCOMP_WHITELIST_APP.TXT` -- Additional syscalls for app compatibility
- `$HOME/aosp-android-11/bionic/libc/SECCOMP_WHITELIST_COMMON.TXT` -- Common whitelist
- `$HOME/aosp-android-11/bionic/libc/SECCOMP_BLACKLIST_APP.TXT` -- Explicitly blocked syscalls

### 8.8 File Descriptor Sanitizer (fdsan)

**Key file:** `$HOME/aosp-android-11/bionic/libc/bionic/fdsan.cpp`
...
**Key directory:** `$HOME/aosp-android-11/bionic/libm/`
...
**Key file:** `$HOME/aosp-android-11/bionic/libc/Android.bp`
...
| Area | Key File(s) |
|------|-------------|
| Bionic overview | `$HOME/aosp-android-11/bionic/README.md` |
| NDK changes guide | `$HOME/aosp-android-11/bionic/android-changes-for-ndk-developers.md` |
| Linker entry point | `$HOME/aosp-android-11/bionic/linker/linker_main.cpp` |
| Linker core logic | `$HOME/aosp-android-11/bionic/linker/linker.cpp` |
| dlopen/dlsym impl | `$HOME/aosp-android-11/bionic/linker/dlfcn.cpp` |
| Linker namespaces | `$HOME/aosp-android-11/bionic/linker/linker_namespaces.h` |
| soinfo structure | `$HOME/aosp-android-11/bionic/linker/linker_soinfo.h` |
| CFI shadow | `$HOME/aosp-android-11/bionic/linker/linker_cfi.h` |
| Syscall definitions | `$HOME/aosp-android-11/bionic/libc/SYSCALLS.TXT` |
| Thread creation | `$HOME/aosp-android-11/bionic/libc/bionic/pthread_create.cpp` |
| Mutex implementation | `$HOME/aosp-android-11/bionic/libc/bionic/pthread_mutex.cpp` |
| ELF TLS | `$HOME/aosp-android-11/bionic/libc/bionic/bionic_elf_tls.cpp` |
| Malloc dispatch | `$HOME/aosp-android-11/bionic/libc/bionic/malloc_common.cpp` |
| GWP-ASan | `$HOME/aosp-android-11/bionic/libc/bionic/gwp_asan_wrappers.cpp` |
| Tagged pointers | `$HOME/aosp-android-11/bionic/libc/bionic/malloc_tagged_pointers.h` |
| Heap tagging | `$HOME/aosp-android-11/bionic/libc/bionic/heap_tagging.cpp` |
| VDSO integration | `$HOME/aosp-android-11/bionic/libc/bionic/vdso.cpp` |
| Stack canary | `$HOME/aosp-android-11/bionic/libc/bionic/__stack_chk_fail.cpp` |
| FORTIFY string.h | `$HOME/aosp-android-11/bionic/libc/include/bits/fortify/string.h` |
| fdsan | `$HOME/aosp-android-11/bionic/libc/bionic/fdsan.cpp` |
| Seccomp policy | `$HOME/aosp-android-11/bionic/libc/seccomp/seccomp_policy.cpp` |
| Seccomp app whitelist | `$HOME/aosp-android-11/bionic/libc/SECCOMP_WHITELIST_APP.TXT` |
| API versioning | `$HOME/aosp-android-11/bionic/libc/include/android/versioning.h` |
| Symbol map | `$HOME/aosp-android-11/bionic/libc/libc.map.txt` |
| dlfcn header | `$HOME/aosp-android-11/bionic/libc/include/dlfcn.h` |
| Build configuration | `$HOME/aosp-android-11/bionic/libc/Android.bp` |
