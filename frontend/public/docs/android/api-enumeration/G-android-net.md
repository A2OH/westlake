...
- **Extends:** `android.net.PlatformVpnProfile`
...
- **Implements:** `java.lang.Comparable<android.net.Uri> android.os.Parcelable`
...
- **Implements:** `java.lang.Cloneable android.os.Parcelable java.io.Serializable`
...
- **Extends:** `android.net.wifi.aware.PeerHandle`
- **Implements:** `android.os.Parcelable`
...
- **Extends:** `android.net.wifi.aware.DiscoverySession`
...
- **Implements:** `android.os.Parcelable android.net.TransportInfo`
