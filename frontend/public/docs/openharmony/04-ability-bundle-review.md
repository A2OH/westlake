# OpenHarmony 4.1 Code Review: Ability Framework and Bundle Management
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/ability_manager_service.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/ability_record.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/lifecycle_deal.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/mission_list_manager.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/scene_board/ui_ability_lifecycle_manager.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/ability_connect_manager.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/data_ability_manager.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/frameworks/native/appkit/ability_runtime/service_extension_context.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_base/interfaces/kits/native/want/src/want.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/implicit_start_processor.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/ability_manager_stub.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/src/ability_manager_proxy.cpp`
...
**File:** `$HOME/openharmony/foundation/bundlemanager/bundle_framework/services/bundlemgr/src/base_bundle_installer.cpp`
...
**File:** `$HOME/openharmony/foundation/bundlemanager/bundle_framework/services/bundlemgr/src/bundle_install_checker.cpp`
...
**File:** `$HOME/openharmony/foundation/bundlemanager/bundle_framework/services/bundlemgr/src/bundle_verify_mgr.cpp`
...
**File:** `$HOME/openharmony/foundation/bundlemanager/bundle_framework/services/bundlemgr/src/sandbox_app/bundle_sandbox_installer.cpp`
...
**File:** `$HOME/openharmony/foundation/bundlemanager/bundle_framework/services/bundlemgr/src/bundle_permission_mgr.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/uripermmgr/src/uri_permission_manager_stub_impl.cpp`
...
**File:** `$HOME/openharmony/foundation/bundlemanager/bundle_framework/services/bundlemgr/src/bundle_mgr_host_impl.cpp`
...
**File:** `$HOME/openharmony/foundation/ability/ability_runtime/services/abilitymgr/include/ability_util.h`
