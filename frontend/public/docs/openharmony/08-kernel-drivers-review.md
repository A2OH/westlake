...
Key files reviewed:
- `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/vnode/src/hdf_vnode_adapter.c` -- Kernel ioctl entry point
- `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/syscall/src/hdf_syscall_adapter.c` -- User-space syscall adapter
- `$HOME/openharmony/drivers/hdf_core/framework/utils/src/hdf_sbuf.c` -- Serialization buffer
- `$HOME/openharmony/drivers/hdf_core/framework/utils/src/hdf_sbuf_impl_raw.c` -- Raw SBuf implementation
- `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/manager/src/devmgr_service_stub.c` -- Device manager IPC stub
- `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/manager/src/devsvc_manager_stub.c` -- Service manager IPC stub
- `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/ipc/src/hdf_remote_adapter.cpp` -- IPC remote adapter
- `$HOME/openharmony/drivers/hdf_core/adapter/khdf/liteos/platform/src/i2c_dev.c` -- I2C platform driver
- `$HOME/openharmony/drivers/hdf_core/adapter/khdf/liteos/platform/src/gpio_dev.c` -- GPIO platform driver
- `$HOME/openharmony/drivers/hdf_core/framework/core/host/src/hdf_load_vdi.c` -- VDI dynamic loading
- `$HOME/openharmony/kernel/liteos_a/kernel/base/vm/shm.c` -- LiteOS shared memory
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/host/src/hdf_load_vdi.c`, lines 24-74
...
**Severity: HIGH**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/manager/src/devmgr_service_stub.c`, lines 152-223
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/vnode/src/hdf_vnode_adapter.c`, lines 276-312, 415-452
...
**Severity: HIGH**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/manager/src/devsvc_manager_stub.c`, lines 35-71
...
**Severity: CRITICAL**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/khdf/liteos/platform/src/i2c_dev.c`, lines 399-417
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/vnode/src/hdf_vnode_adapter.c`, lines 700-712
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/ipc/src/hdf_remote_adapter.cpp`, lines 438-448
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/ipc/src/hdf_remote_adapter.cpp`, lines 98-100
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/vnode/src/hdf_vnode_adapter.c`, line 24
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/utils/src/hdf_sbuf_impl_raw.c`, lines 360-390
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/syscall/src/hdf_syscall_adapter.c`, lines 51-69
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/vnode/src/hdf_vnode_adapter.c`, lines 368-379, 415-437
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/utils/src/hdf_sbuf_impl_raw.c`, lines 442-465
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/manager/src/devmgr_service.c`, lines 475-495
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/utils/src/hdf_sbuf.c`, lines 407-420, 466-486
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/adapter/vnode/src/hdf_vnode_adapter.c`, line 661
...
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/host/src/hdf_load_vdi.c`, line 94
...
**Severity: LOW**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/khdf/liteos/platform/src/i2c_dev.c`, lines 252-294
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/framework/core/manager/src/devmgr_service.c`, lines 307-334
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/drivers/hdf_core/adapter/uhdf2/ipc/src/hdf_remote_adapter.cpp`, lines 266-293
