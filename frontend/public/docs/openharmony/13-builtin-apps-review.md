# OpenHarmony 4.1 Built-in Applications Code Review
...
This review covers the built-in applications shipped with OpenHarmony 4.1 Release, located at `$HOME/openharmony/applications/standard/`. These applications serve both as system components and as reference implementations for third-party developers. The review identified **3 critical security issues**, **5 high-severity code quality problems**, and numerous medium and low severity items that collectively undermine the example-setting purpose of these apps.
...
- **Source Path:** `$HOME/openharmony/applications/standard/`
...
| Application | Path | Source Files | Description |
|---|---|---|---|
...
| Notes | `notes/` | ~40 | Notes application |
...
**Severity: CRITICAL**
**File:** `$HOME/openharmony/applications/standard/app_samples/code/BasicFeature/Security/PaySecurely/cloud/src/main/ets/PayServer.ts`
...
**Severity: CRITICAL**
**File:** `$HOME/openharmony/applications/standard/settings/product/phone/src/main/ets/pages/wifi.ets` (lines 793-798)
...
**Severity: HIGH**
**File:** `$HOME/openharmony/applications/standard/dlp_manager/entry/src/main/ets/feature/HomeFeature.ets` (line 125)
...
**Severity: MEDIUM**
**File:** `$HOME/openharmony/applications/standard/systemui/entry/phone/src/main/module.json5`
...
| Hardcoded bundle names | Notes | Use intent actions for implicit capability discovery |
