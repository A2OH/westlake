...
关键源码路径：
- `$HOME/aosp-android-11/bionic/libc/bionic/` -- 核心 C 库实现
- `$HOME/aosp-android-11/bionic/libc/include/` -- 公共头文件
- `$HOME/aosp-android-11/bionic/libc/kernel/` -- 经过清理的内核 UAPI 头文件
- `$HOME/aosp-android-11/bionic/libc/arch-arm/`, `arch-arm64/`, `arch-x86/`, `arch-x86_64/` -- 架构特定代码
- `$HOME/aosp-android-11/bionic/libc/upstream-freebsd/`, `upstream-netbsd/`, `upstream-openbsd/` -- 来自 BSD 的代码
...
**关键文件：** `$HOME/aosp-android-11/bionic/linker/linker_main.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/linker/linker_namespaces.h`
...
**关键文件：** `$HOME/aosp-android-11/bionic/linker/dlfcn.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/linker/linker.cpp`（约第 192 行）
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/SYSCALLS.TXT`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/vdso.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/pthread_create.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/pthread_mutex.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/malloc_common.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/Android.bp`（第 94-120 行）
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/gwp_asan_wrappers.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/malloc_tagged_pointers.h`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/heap_tagging.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/include/android/versioning.h`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/libc.map.txt`
...
**关键目录：** `$HOME/aosp-android-11/bionic/libc/include/`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/include/dlfcn.h`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/__stack_chk_fail.cpp`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/include/bits/fortify/string.h` 及同级头文件
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/pthread_create.cpp`（第 109-133 行）
...
**关键文件：** `$HOME/aosp-android-11/bionic/linker/linker_cfi.h`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/seccomp/seccomp_policy.cpp`
...
白名单文件定义允许的系统调用：
- `$HOME/aosp-android-11/bionic/libc/SECCOMP_WHITELIST_APP.TXT` -- 用于应用兼容性的额外系统调用
- `$HOME/aosp-android-11/bionic/libc/SECCOMP_WHITELIST_COMMON.TXT` -- 通用白名单
- `$HOME/aosp-android-11/bionic/libc/SECCOMP_BLACKLIST_APP.TXT` -- 明确阻止的系统调用

### 8.8 文件描述符清理器（fdsan）

**关键文件：** `$HOME/aosp-android-11/bionic/libc/bionic/fdsan.cpp`
...
**关键目录：** `$HOME/aosp-android-11/bionic/libm/`
...
**关键文件：** `$HOME/aosp-android-11/bionic/libc/Android.bp`
...
| 领域 | 关键文件 |
|------|-------------|
| Bionic 概述 | `$HOME/aosp-android-11/bionic/README.md` |
| NDK 变更指南 | `$HOME/aosp-android-11/bionic/android-changes-for-ndk-developers.md` |
| 链接器入口点 | `$HOME/aosp-android-11/bionic/linker/linker_main.cpp` |
| 链接器核心逻辑 | `$HOME/aosp-android-11/bionic/linker/linker.cpp` |
| dlopen/dlsym 实现 | `$HOME/aosp-android-11/bionic/linker/dlfcn.cpp` |
| 链接器命名空间 | `$HOME/aosp-android-11/bionic/linker/linker_namespaces.h` |
| soinfo 结构 | `$HOME/aosp-android-11/bionic/linker/linker_soinfo.h` |
| CFI 影子 | `$HOME/aosp-android-11/bionic/linker/linker_cfi.h` |
| 系统调用定义 | `$HOME/aosp-android-11/bionic/libc/SYSCALLS.TXT` |
| 线程创建 | `$HOME/aosp-android-11/bionic/libc/bionic/pthread_create.cpp` |
| 互斥锁实现 | `$HOME/aosp-android-11/bionic/libc/bionic/pthread_mutex.cpp` |
| ELF TLS | `$HOME/aosp-android-11/bionic/libc/bionic/bionic_elf_tls.cpp` |
| Malloc 分派 | `$HOME/aosp-android-11/bionic/libc/bionic/malloc_common.cpp` |
| GWP-ASan | `$HOME/aosp-android-11/bionic/libc/bionic/gwp_asan_wrappers.cpp` |
| 标记指针 | `$HOME/aosp-android-11/bionic/libc/bionic/malloc_tagged_pointers.h` |
| 堆标记 | `$HOME/aosp-android-11/bionic/libc/bionic/heap_tagging.cpp` |
| VDSO 集成 | `$HOME/aosp-android-11/bionic/libc/bionic/vdso.cpp` |
| 栈金丝雀 | `$HOME/aosp-android-11/bionic/libc/bionic/__stack_chk_fail.cpp` |
...
| Seccomp 策略 | `$HOME/aosp-android-11/bionic/libc/seccomp/seccomp_policy.cpp` |
| Seccomp 应用白名单 | `$HOME/aosp-android-11/bionic/libc/SECCOMP_WHITELIST_APP.TXT` |
| API 版本控制 | `$HOME/aosp-android-11/bionic/libc/include/android/versioning.h` |
| 符号映射 | `$HOME/aosp-android-11/bionic/libc/libc.map.txt` |
| dlfcn 头文件 | `$HOME/aosp-android-11/bionic/libc/include/dlfcn.h` |
| 构建配置 | `$HOME/aosp-android-11/bionic/libc/Android.bp` |
