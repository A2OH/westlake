...
- **继承：** `android.media.AudioMetadataReadMap`
...
- **实现：** `android.media.AudioRecordingMonitor android.media.AudioRouting android.media.MicrophoneDirection`
...
- **继承：** `android.media.AudioRouting.OnRoutingChangedListener`
- **注解：** `@Deprecated`
...
- **实现：** `android.media.AudioRouting android.media.VolumeAutomation`
...
- **继承：** `android.media.MediaDrmException`
...
- **继承：** `android.media.MediaCasException`
...
- **继承：** `android.media.MediaParser.InputReader`
...
- **继承：** `android.media.MediaRouter.RouteInfo`
...
- **继承：** `android.media.MediaRouter.Callback`
...
- **继承：** `android.media.MediaScannerConnection.OnScanCompletedListener`
...
- **继承：** `android.media.MediaMetadataEditor`
- **注解：** `@Deprecated`
...
- **继承：** `android.media.audiofx.AudioEffect`
...
- **继承：** `android.media.audiofx.DynamicsProcessing.Stage`
...
- **继承：** `android.media.audiofx.DynamicsProcessing.BandStage`
...
- **继承：** `android.media.audiofx.DynamicsProcessing.BandBase`
...
- **继承：** `android.media.midi.MidiReceiver`
- **实现：** `java.io.Closeable`
...
- **继承：** `android.media.midi.MidiSender`
- **实现：** `java.io.Closeable`
...
- **实现：** `android.media.tv.TvContract.BaseTvColumns`
