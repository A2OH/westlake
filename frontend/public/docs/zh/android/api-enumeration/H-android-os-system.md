...
- **继承：** `android.os.DeadObjectException`
...
- **继承：** `android.os.Parcelable.Creator<T>`
...
- **继承：** `android.os.strictmode.Violation`
...
- **继承：** `android.security.identity.IdentityCredentialException`
...
- **继承：** `java.security.InvalidKeyException`
...
- **继承：** `java.security.ProviderException`
...
- **实现：** `java.lang.Comparable<android.system.StructTimespec>`
