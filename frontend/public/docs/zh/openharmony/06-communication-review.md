...
**严重性：** 严重
**文件：**
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/http/http_exec/src/http_exec.cpp`（第 774-775 行）
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/fetch/fetch_exec/src/fetch_exec.cpp`（第 274-275 行）
- `$HOME/openharmony/foundation/communication/netstack/frameworks/native/http/http_client/http_client_task.cpp`（第 174-175 行）
...
**严重性：** 严重
**文件：**
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp`（第 573 行）
- `$HOME/openharmony/foundation/communication/netstack/frameworks/native/websocket_client/websocket_client.cpp`（第 373 行）
...
**严重性：** 高
**文件：**
- `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/wifi_auth_center.cpp`（第 30-34 行）
- `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/BUILD.gn`（第 107 行）
- `$HOME/openharmony/foundation/communication/wifi/wifi/wifi_lite.gni`（第 27 行）
...
**严重性：** 高
**文件：** `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/common/wifi_permission_utils.cpp`（第 23-87 行）
...
**严重性：** 高
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/tlssocket_exec.cpp`（多处）
...
**严重性：** 高
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/tlssocket_exec.cpp`（第 230-239 行）
...
**严重性：** 高
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp`（第 181 行）
...
**严重性：** 中
**文件：** `$HOME/openharmony/foundation/communication/wifi/wifi/services/wifi_standard/wifi_framework/wifi_manage/wifi_sta/sta_state_machine.cpp`（第 48-49 行）
...
**严重性：** 中
**文件：**
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp`（第 670 行）
- `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/http/http_exec/src/http_exec.cpp`（第 188 行）
- `$HOME/openharmony/foundation/communication/netstack/frameworks/native/tls_socket/src/tls_socket.cpp`（第 410 行）
...
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/builtin/BUILD.gn`（第 47 行）
...
**严重性：** 中
**文件：** `$HOME/openharmony/foundation/communication/dsoftbus/core/authentication/src/auth_session_message.c`
...
**严重性：** 中
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/websocket/websocket_exec/src/websocket_exec.cpp`
...
**严重性：** 低
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/context/tls_connect_context.cpp`（第 159-169 行）
...
**严重性：** 低
**文件：** `$HOME/openharmony/foundation/communication/netstack/frameworks/js/napi/tls/src/tlssocket_exec.cpp`（第 35-36 行）
...
**严重性：** 低
**文件：** `$HOME/openharmony/foundation/communication/bluetooth/frameworks/js/napi/src/ble/napi_bluetooth_ble.cpp`（第 105-131 行）
