...
多媒体子系统位于 `$HOME/openharmony/foundation/multimedia/`，包含：
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/src/hcamera_service.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/src/hcapture_session.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/src/hcamera_device.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/src/hstream_capture.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/src/hstream_repeat.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/binder/server/src/hcamera_service_stub.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/camera_framework/services/camera_service/src/camera_util.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/audio_framework/services/audio_service/server/src/audio_service.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/audio_framework/services/audio_service/server/src/audio_endpoint.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/audio_framework/services/audio_service/common/src/oh_audio_buffer.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/audio_framework/services/audio_service/common/src/audio_ring_cache.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/audio_framework/services/audio_service/server/src/ipc_stream_in_server.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/audio_framework/services/audio_service/server/src/audio_server.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/player_framework/services/services/player/server/player_server.h`
...
**文件:** `$HOME/openharmony/foundation/multimedia/player_framework/services/services/player/ipc/player_service_stub.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/player_framework/services/services/screen_capture/server/screen_capture_server.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/player_framework/services/utils/task_queue.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/player_framework/services/utils/uri_helper.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/player_framework/services/utils/media_permission.cpp`
...
**文件:** `$HOME/openharmony/foundation/multimedia/image_framework/frameworks/innerkitsimpl/codec/src/image_source.cpp`
...
*审查基于 OpenHarmony 4.1 发布版代码库执行，聚焦于 `$HOME/openharmony/foundation/multimedia/`。分析日期：2026-03-10。*
