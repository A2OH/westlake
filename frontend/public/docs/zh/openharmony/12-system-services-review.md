# OpenHarmony 4.1 System Services Layer - 代码审查
...
**Severity: CRITICAL**
**File**: `$HOME/openharmony/base/startup/appspawn/standard/appspawn_process.c`, lines 141-149
...
**Severity: HIGH**
**File**: `$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`, lines 645-652
...
**Severity: HIGH**
**File**: `$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`, lines 411-427
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`, lines 53, 466-499
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`, lines 501-515
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/startup/appspawn/standard/appspawn_process.c`, lines 405-489
...
**Severity: LOW**
**File**: `$HOME/openharmony/base/startup/appspawn/common/appspawn_server.c`, lines 66-81
...
**Severity: CRITICAL**
**File**: `$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`, lines 45-99
...
**Severity: HIGH**
**File**: `$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`, lines 996-1003
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`, lines 234-296
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`, lines 981-994
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`, lines 666-685, 835-854
...
**Severity: LOW**
**File**: `$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager.cpp`, lines 192-224
...
**Severity: HIGH**
**File**: `$HOME/openharmony/base/powermgr/power_manager/services/zidl/src/power_mgr_stub.cpp`, lines 39-170
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/powermgr/power_manager/services/zidl/src/power_mgr_stub.cpp`, line 153-155
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/sensors/sensor/services/src/sensor_service_stub.cpp`, lines 162-179
...
**Severity: LOW**
**File**: `$HOME/openharmony/base/sensors/sensor/services/src/sensor_service_stub.cpp`, lines 98-108
...
**File**: `$HOME/openharmony/base/location/frameworks/location_common/common/source/common_utils.cpp`, lines 45-118
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/location/services/`
...
**Severity: CRITICAL**
**File**: `$HOME/openharmony/base/notification/common_event_service/frameworks/core/src/common_event_stub.cpp`, lines 32-228
...
**Severity: HIGH**
**File**: `$HOME/openharmony/base/notification/distributed_notification_service/frameworks/core/src/ans_manager_stub.cpp`
...
**Severity: HIGH**
**File**: `$HOME/openharmony/base/inputmethod/imf/services/src/input_method_system_ability_stub.cpp`
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/inputmethod/imf/services/src/input_method_system_ability.cpp`, line 671
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/base/inputmethod/imf/services/src/input_method_system_ability.cpp`, lines 492-509
...
**Severity: HIGH**
**File**: `$HOME/openharmony/foundation/multimodalinput/input/service/connect_manager/src/multimodal_input_connect_stub.cpp`, lines 177-182
...
**Severity: MEDIUM**
**File**: `$HOME/openharmony/foundation/multimodalinput/input/service/connect_manager/src/multimodal_input_connect_stub.cpp`, lines 411, 452
...
**Severity: LOW**
**File**: `$HOME/openharmony/foundation/multimodalinput/input/service/connect_manager/src/multimodal_input_connect_stub.cpp`, line 53
...
**Severity: HIGH**
**File**: `$HOME/openharmony/foundation/resourceschedule/background_task_mgr/frameworks/src/background_task_mgr_stub.cpp`
...
**Severity: INFORMATIONAL (Positive Finding)**
**File**: `$HOME/openharmony/base/account/os_account/services/accountmgr/src/osaccount/os_account_stub.cpp`
