...
**严重等级：严重**
**文件**：`$HOME/openharmony/base/startup/appspawn/standard/appspawn_process.c`，第 141-149 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`，第 645-652 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`，第 411-427 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`，第 53、466-499 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/startup/appspawn/standard/appspawn_service.c`，第 501-515 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/startup/appspawn/standard/appspawn_process.c`，第 405-489 行
...
**严重等级：低危**
**文件**：`$HOME/openharmony/base/startup/appspawn/common/appspawn_server.c`，第 66-81 行
...
**严重等级：严重**
**文件**：`$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`，第 45-99 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`，第 996-1003 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`，第 234-296 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`，第 981-994 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager_stub.cpp`，第 666-685、835-854 行
...
**严重等级：低危**
**文件**：`$HOME/openharmony/foundation/systemabilitymgr/samgr/services/samgr/native/source/system_ability_manager.cpp`，第 192-224 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/base/powermgr/power_manager/services/zidl/src/power_mgr_stub.cpp`，第 39-170 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/powermgr/power_manager/services/zidl/src/power_mgr_stub.cpp`，第 153-155 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/sensors/sensor/services/src/sensor_service_stub.cpp`，第 162-179 行
...
**严重等级：低危**
**文件**：`$HOME/openharmony/base/sensors/sensor/services/src/sensor_service_stub.cpp`，第 98-108 行
...
**严重等级：信息性（正面发现）**
**文件**：`$HOME/openharmony/base/location/frameworks/location_common/common/source/common_utils.cpp`，第 45-118 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/location/services/`
...
**严重等级：严重**
**文件**：`$HOME/openharmony/base/notification/common_event_service/frameworks/core/src/common_event_stub.cpp`，第 32-228 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/base/notification/distributed_notification_service/frameworks/core/src/ans_manager_stub.cpp`
...
**严重等级：高危**
**文件**：`$HOME/openharmony/base/inputmethod/imf/services/src/input_method_system_ability_stub.cpp`
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/inputmethod/imf/services/src/input_method_system_ability.cpp`，第 671 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/base/inputmethod/imf/services/src/input_method_system_ability.cpp`，第 492-509 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/foundation/multimodalinput/input/service/connect_manager/src/multimodal_input_connect_stub.cpp`，第 177-182 行
...
**严重等级：中危**
**文件**：`$HOME/openharmony/foundation/multimodalinput/input/service/connect_manager/src/multimodal_input_connect_stub.cpp`，第 411、452 行
...
**严重等级：低危**
**文件**：`$HOME/openharmony/foundation/multimodalinput/input/service/connect_manager/src/multimodal_input_connect_stub.cpp`，第 53 行
...
**严重等级：高危**
**文件**：`$HOME/openharmony/foundation/resourceschedule/background_task_mgr/frameworks/src/background_task_mgr_stub.cpp`
...
**严重等级：信息性（正面发现）**
**文件**：`$HOME/openharmony/base/account/os_account/services/accountmgr/src/osaccount/os_account_stub.cpp`
