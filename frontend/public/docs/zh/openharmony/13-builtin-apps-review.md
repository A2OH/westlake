...
本次审查涵盖了 OpenHarmony 4.1 Release 附带的内置应用，位于 `$HOME/openharmony/applications/standard/`。这些应用既是系统组件，也是第三方开发者的参考实现。审查发现了 **3 个关键安全问题**、**5 个高严重性代码质量问题**，以及大量中等和低严重性问题，这些问题共同削弱了这些应用的示范作用。
...
- **源码路径：** `$HOME/openharmony/applications/standard/`
...
**严重程度：关键**
**文件：** `$HOME/openharmony/applications/standard/app_samples/code/BasicFeature/Security/PaySecurely/cloud/src/main/ets/PayServer.ts`
...
**严重程度：关键**
**文件：** `$HOME/openharmony/applications/standard/settings/product/phone/src/main/ets/pages/wifi.ets`（第 793-798 行）
...
**严重程度：高**
**文件：** `$HOME/openharmony/applications/standard/dlp_manager/entry/src/main/ets/feature/HomeFeature.ets`（第 125 行）
...
**严重程度：中**
**文件：** `$HOME/openharmony/applications/standard/systemui/entry/phone/src/main/module.json5`
