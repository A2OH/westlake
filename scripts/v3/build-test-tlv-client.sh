...
CC="${CC:-$HOME/openharmony/prebuilts/clang/ohos/linux-x86_64/llvm/bin/armv7-unknown-linux-ohos-clang}"
SYSROOT="${SYSROOT:-$HOME/openharmony/out/sdk/sdk-native/os-irrelevant/sysroot}"
