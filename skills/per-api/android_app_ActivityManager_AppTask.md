...
| `moveToFront` | 4 | composite | Store callback, never fire |
| `getTaskInfo` | 3 | composite | Return safe default (null/false/0/empty) |
| `finishAndRemoveTask` | 1 | none | Return safe default (null/false/0/empty) |
| `setExcludeFromRecents` | 1 | none | Log warning + no-op |
