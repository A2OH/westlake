...
|---|---|---|---|
| `updateDate` | 3 | composite | Log warning + no-op |
| `setOnDateSetListener` | 2 | composite | Return safe default (null/false/0/empty) |
| `DatePickerDialog` | 1 | none | throw UnsupportedOperationException |
| `DatePickerDialog` | 1 | none | throw UnsupportedOperationException |
| `DatePickerDialog` | 1 | none | throw UnsupportedOperationException |
| `DatePickerDialog` | 1 | none | throw UnsupportedOperationException |
| `onClick` | 1 | none | Store callback, never fire |
| `onDateChanged` | 1 | none | Store callback, never fire |
