...
|---|---|---|---|
| `ActivityResult` | 3 | composite | throw UnsupportedOperationException |
| `getResultCode` | 3 | composite | Return safe default (null/false/0/empty) |
| `getResultData` | 2 | composite | Return safe default (null/false/0/empty) |
