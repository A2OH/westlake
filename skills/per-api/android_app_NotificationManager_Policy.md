...
| `priorityCategoriesToString` | 1 | none | throw UnsupportedOperationException |
| `prioritySendersToString` | 1 | none | throw UnsupportedOperationException |
| `suppressedEffectsToString` | 1 | none | throw UnsupportedOperationException |
