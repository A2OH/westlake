...
| `getDisplay` | 2 | composite | Return safe default (null/false/0/empty) |
| `Presentation` | 1 | none | Store callback, never fire |
| `Presentation` | 1 | none | Store callback, never fire |
| `onDisplayChanged` | 1 | none | Return safe default (null/false/0/empty) |
| `onDisplayRemoved` | 1 | none | Return safe default (null/false/0/empty) |
