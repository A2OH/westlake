...
|---|---|---|---|
| `getCurrentModeType` | 4 | partial | Return safe default (null/false/0/empty) |
| `disableCarMode` | 4 | composite | Return safe default (null/false/0/empty) |
| `enableCarMode` | 3 | composite | throw UnsupportedOperationException |
| `getNightMode` | 3 | composite | Return safe default (null/false/0/empty) |
| `setCustomNightModeEnd` | 1 | none | Log warning + no-op |
| `setCustomNightModeStart` | 1 | none | Return dummy instance / no-op |
| `setNightMode` | 1 | none | Log warning + no-op |
