...
|---|---|---|---|
| `getActiveRequest` | 3 | composite | Return safe default (null/false/0/empty) |
| `getActiveRequests` | 3 | composite | Return safe default (null/false/0/empty) |
| `submitRequest` | 3 | composite | throw UnsupportedOperationException |
| `submitRequest` | 3 | composite | throw UnsupportedOperationException |
| `registerOnDestroyedCallback` | 3 | composite | No-op |
| `unregisterOnDestroyedCallback` | 2 | composite | No-op |
| `isDestroyed` | 1 | none | No-op |
| `notifyDirectActionsChanged` | 1 | none | Store callback, never fire |
