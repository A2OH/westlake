# SKILL: android.app.WallpaperColors

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.app.WallpaperColors`.
...
Check if these related classes are already shimmed before generating `android.app.WallpaperColors`:

- `android.content.Context` (already shimmed)

## Quality Gates

Before marking `android.app.WallpaperColors` as done:
