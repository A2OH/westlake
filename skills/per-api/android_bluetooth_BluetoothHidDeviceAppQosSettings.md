...
|---|---|---|---|
| `getTokenRate` | 4 | partial | Return safe default (null/false/0/empty) |
| `BluetoothHidDeviceAppQosSettings` | 4 | partial | Log warning + no-op |
| `getLatency` | 4 | partial | Return safe default (null/false/0/empty) |
| `getServiceType` | 2 | composite | Return safe default (null/false/0/empty) |
| `describeContents` | 1 | none | Store callback, never fire |
| `getDelayVariation` | 1 | none | Return safe default (null/false/0/empty) |
| `getPeakBandwidth` | 1 | none | Return safe default (null/false/0/empty) |
| `getTokenBucketSize` | 1 | none | Return safe default (null/false/0/empty) |
