...
|---|---|---|---|
| `setKeepUpdated` | 4 | partial | Log warning + no-op |
| `getValues` | 4 | partial | Return safe default (null/false/0/empty) |
| `close` | 3 | composite | No-op |
| `getRows` | 3 | composite | Return safe default (null/false/0/empty) |
| `ContentQueryMap` | 1 | none | Return safe default (null/false/0/empty) |
