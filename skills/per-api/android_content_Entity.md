...
|---|---|---|---|
| `addSubValue` | 5 | partial | Log warning + no-op |
| `getEntityValues` | 4 | partial | Return safe default (null/false/0/empty) |
| `getSubValues` | 2 | composite | Return safe default (null/false/0/empty) |
