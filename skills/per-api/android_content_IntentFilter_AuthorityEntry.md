...
|---|---|---|---|---|---|---|
| `getPort` | `int getPort()` | 5 | partial | moderate | `getCount` | `getCount(): number` |
...
|---|---|---|---|
| `AuthorityEntry` | 5 | partial | throw UnsupportedOperationException |
| `getHost` | 4 | partial | Return safe default (null/false/0/empty) |
