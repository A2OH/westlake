...
|---|---|---|---|
| `SyncAdapterType` | 5 | partial | throw UnsupportedOperationException |
| `SyncAdapterType` | 5 | partial | throw UnsupportedOperationException |
| `newKey` | 4 | partial | throw UnsupportedOperationException |
| `isUserVisible` | 3 | composite | Return safe default (null/false/0/empty) |
...
| `isAlwaysSyncable` | 1 | none | Return safe default (null/false/0/empty) |
