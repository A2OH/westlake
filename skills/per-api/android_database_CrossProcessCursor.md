# SKILL: android.database.CrossProcessCursor

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.database.CrossProcessCursor`.
...
Check if these related classes are already shimmed before generating `android.database.CrossProcessCursor`:


## Quality Gates

Before marking `android.database.CrossProcessCursor` as done:
