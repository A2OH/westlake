...
| `restore` | 3 | composite | throw UnsupportedOperationException |
| `save` | 3 | composite | throw UnsupportedOperationException |
| `rotate` | 3 | composite | throw UnsupportedOperationException |
| `translate` | 3 | composite | throw UnsupportedOperationException |
| `Camera` | 1 | none | throw UnsupportedOperationException |
| `applyToCanvas` | 1 | none | Return safe default (null/false/0/empty) |
| `dotWithNormal` | 1 | none | throw UnsupportedOperationException |
| `getLocationX` | 1 | none | Return safe default (null/false/0/empty) |
| `getLocationY` | 1 | none | Return safe default (null/false/0/empty) |
| `getLocationZ` | 1 | none | Return safe default (null/false/0/empty) |
| `rotateX` | 1 | none | throw UnsupportedOperationException |
| `rotateY` | 1 | none | throw UnsupportedOperationException |
| `rotateZ` | 1 | none | throw UnsupportedOperationException |
