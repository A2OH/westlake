...
| `YuvImage` | 1 | none | throw UnsupportedOperationException |
| `compressToJpeg` | 1 | none | throw UnsupportedOperationException |
| `getStrides` | 1 | none | Return safe default (null/false/0/empty) |
| `getYuvData` | 1 | none | Return safe default (null/false/0/empty) |
| `getYuvFormat` | 1 | none | Return safe default (null/false/0/empty) |
