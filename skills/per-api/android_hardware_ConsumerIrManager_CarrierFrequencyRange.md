...
|---|---|---|---|
| `CarrierFrequencyRange` | 5 | partial | throw UnsupportedOperationException |
| `getMinFrequency` | 3 | composite | Return safe default (null/false/0/empty) |
| `getMaxFrequency` | 3 | composite | Return safe default (null/false/0/empty) |
