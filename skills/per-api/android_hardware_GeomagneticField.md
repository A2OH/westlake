...
|---|---|---|---|
| `getFieldStrength` | 4 | partial | Return safe default (null/false/0/empty) |
| `getDeclination` | 4 | partial | Return safe default (null/false/0/empty) |
| `getInclination` | 4 | partial | Return safe default (null/false/0/empty) |
| `getHorizontalStrength` | 4 | partial | Return safe default (null/false/0/empty) |
| `getX` | 3 | composite | Return safe default (null/false/0/empty) |
| `getY` | 3 | composite | Return safe default (null/false/0/empty) |
| `getZ` | 3 | composite | Return safe default (null/false/0/empty) |
