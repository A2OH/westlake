...
|---|---|---|---|---|---|---|
| `play` | `void play(@NonNull android.content.Context, @NonNull android.net.Uri, boolean, @NonNull android.media.AudioAttributes) throws java.lang.IllegalArgumentException` | 5 | partial | moderate | `play` | `play(): void` |
...
| `AsyncPlayer` | 3 | composite | throw UnsupportedOperationException |
