...
|---|---|---|---|
| `AudioDeviceCallback` | 3 | composite | throw UnsupportedOperationException |
| `onAudioDevicesAdded` | 3 | composite | Log warning + no-op |
| `onAudioDevicesRemoved` | 3 | composite | Log warning + no-op |
