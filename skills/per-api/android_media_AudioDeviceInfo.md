...
|---|---|---|---|---|---|---|
| `isSink` | `boolean isSink()` | 5 | partial | moderate | `isOnline` | `readonly isOnline: boolean` |
...
| `getProductName` | 4 | partial | Return safe default (null/false/0/empty) |
| `getId` | 3 | composite | Return safe default (null/false/0/empty) |
| `isSource` | 3 | composite | Return safe default (null/false/0/empty) |
