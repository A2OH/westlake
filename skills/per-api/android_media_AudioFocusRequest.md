# SKILL: android.media.AudioFocusRequest

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.media.AudioFocusRequest`.
...
Check if these related classes are already shimmed before generating `android.media.AudioFocusRequest`:

- `android.content.Context` (already shimmed)

## Quality Gates

Before marking `android.media.AudioFocusRequest` as done:
