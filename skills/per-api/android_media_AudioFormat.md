...
| `getEncoding` | 5 | partial | Return safe default (null/false/0/empty) |
| `getChannelMask` | 3 | composite | Return safe default (null/false/0/empty) |
| `describeContents` | 1 | none | Store callback, never fire |
| `getChannelIndexMask` | 1 | none | Return safe default (null/false/0/empty) |
