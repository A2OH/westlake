# SKILL: android.media.AudioRouting

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.media.AudioRouting`.
...
Check if these related classes are already shimmed before generating `android.media.AudioRouting`:

- `android.content.Context` (already shimmed)

## Quality Gates

Before marking `android.media.AudioRouting` as done:
