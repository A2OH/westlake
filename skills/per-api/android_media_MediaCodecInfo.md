...
|---|---|---|---|---|---|---|
| `isAlias` | `boolean isAlias()` | 5 | partial | moderate | `isAfterLast` | `isAfterLast(): boolean` |
...
|---|---|---|---|
| `isEncoder` | 3 | composite | Return safe default (null/false/0/empty) |
| `isVendor` | 3 | composite | Return safe default (null/false/0/empty) |
| `getSupportedTypes` | 2 | composite | Return safe default (null/false/0/empty) |
| `getCapabilitiesForType` | 2 | composite | Return safe default (null/false/0/empty) |
| `isHardwareAccelerated` | 1 | none | Return safe default (null/false/0/empty) |
| `isSoftwareOnly` | 1 | none | Return safe default (null/false/0/empty) |
