...
|---|---|---|---|
| `isSampleRateSupported` | 3 | composite | Return safe default (null/false/0/empty) |
| `getSupportedSampleRateRanges` | 3 | composite | Return safe default (null/false/0/empty) |
| `getSupportedSampleRates` | 3 | composite | Return safe default (null/false/0/empty) |
| `getBitrateRange` | 3 | composite | Return safe default (null/false/0/empty) |
| `getMaxInputChannelCount` | 2 | composite | Return safe default (null/false/0/empty) |
