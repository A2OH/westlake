...
|---|---|---|---|
| `getQualityRange` | 4 | partial | Return safe default (null/false/0/empty) |
| `isBitrateModeSupported` | 4 | composite | Return safe default (null/false/0/empty) |
| `getComplexityRange` | 3 | composite | Return safe default (null/false/0/empty) |
