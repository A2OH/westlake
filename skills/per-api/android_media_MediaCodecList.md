...
|---|---|---|---|
| `getCodecInfos` | 4 | partial | Return safe default (null/false/0/empty) |
| `MediaCodecList` | 3 | composite | Return safe default (null/false/0/empty) |
| `findDecoderForFormat` | 2 | composite | Return safe default (null/false/0/empty) |
| `findEncoderForFormat` | 2 | composite | Return safe default (null/false/0/empty) |
