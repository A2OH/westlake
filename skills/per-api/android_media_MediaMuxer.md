...
|---|---|---|---|
| `MediaMuxer` | 5 | partial | throw UnsupportedOperationException |
| `MediaMuxer` | 5 | partial | throw UnsupportedOperationException |
| `setOrientationHint` | 5 | partial | Log warning + no-op |
| `release` | 5 | partial | No-op |
| `start` | 3 | composite | Return dummy instance / no-op |
| `stop` | 3 | composite | No-op |
| `writeSampleData` | 3 | composite | Log warning + no-op |
| `addTrack` | 3 | composite | Log warning + no-op |
| `setLocation` | 2 | composite | Log warning + no-op |
