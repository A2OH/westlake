...
|---|---|---|---|
| `MediaTimestamp` | 5 | partial | throw UnsupportedOperationException |
| `getAnchorSystemNanoTime` | 4 | partial | Return safe default (null/false/0/empty) |
| `getAnchorMediaTimeUs` | 4 | partial | Return safe default (null/false/0/empty) |
