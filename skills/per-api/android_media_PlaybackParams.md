...
|---|---|---|---|
| `setAudioFallbackMode` | 4 | partial | Log warning + no-op |
| `getAudioFallbackMode` | 4 | partial | Return safe default (null/false/0/empty) |
| `getSpeed` | 3 | composite | Return safe default (null/false/0/empty) |
| `PlaybackParams` | 3 | composite | throw UnsupportedOperationException |
| `getPitch` | 3 | composite | Return safe default (null/false/0/empty) |
| `setSpeed` | 2 | composite | Log warning + no-op |
| `allowDefaults` | 1 | none | throw UnsupportedOperationException |
| `describeContents` | 1 | none | Store callback, never fire |
| `setPitch` | 1 | none | Log warning + no-op |
