...
|---|---|---|---|---|---|---|
| `Session2Command` | `Session2Command(int)` | 5 | partial | moderate | `sessionId` | `readonly sessionId: string` |
| `Session2Command` | `Session2Command(@NonNull String, @Nullable android.os.Bundle)` | 5 | partial | moderate | `sessionId` | `readonly sessionId: string` |
...
|---|---|---|---|
| `getCommandCode` | 3 | composite | Return safe default (null/false/0/empty) |
