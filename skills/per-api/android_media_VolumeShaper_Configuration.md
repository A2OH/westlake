...
|---|---|---|---|---|---|---|
| `getDuration` | `long getDuration()` | 6 | partial | moderate | `duration` | `readonly duration: number` |
...
|---|---|---|---|
| `getInterpolatorType` | 4 | partial | Return safe default (null/false/0/empty) |
| `getVolumes` | 3 | composite | Return safe default (null/false/0/empty) |
| `getTimes` | 3 | composite | Return safe default (null/false/0/empty) |
| `getMaximumCurvePoints` | 3 | composite | Return safe default (null/false/0/empty) |
