...
| `registerConnectivityDiagnosticsCallback` | 1 | none | Return dummy instance / no-op |
| `unregisterConnectivityDiagnosticsCallback` | 1 | none | Return dummy instance / no-op |
| `onConnectivityReportAvailable` | 1 | none | Return dummy instance / no-op |
| `onDataStallSuspected` | 1 | none | Store callback, never fire |
| `onNetworkConnectivityReported` | 1 | none | Return dummy instance / no-op |
