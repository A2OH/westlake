...
|---|---|---|---|
| `canBeSatisfiedBy` | 1 | none | Return safe default (null/false/0/empty) |
| `describeContents` | 1 | none | Store callback, never fire |
| `hasCapability` | 1 | none | Return safe default (null/false/0/empty) |
| `hasTransport` | 1 | none | Return safe default (null/false/0/empty) |
