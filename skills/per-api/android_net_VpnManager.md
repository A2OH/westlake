...
|---|---|---|---|
| `deleteProvisionedVpnProfile` | 1 | none | Return safe default (null/false/0/empty) |
| `startProvisionedVpnProfile` | 1 | none | Return dummy instance / no-op |
| `stopProvisionedVpnProfile` | 1 | none | No-op |
