...
|---|---|---|---|---|---|---|
| `isCharging` | `boolean isCharging()` | 7 | near | moderate | `chargingStatus` | `@ohos.batteryInfo.batteryInfo` |

## Gap Descriptions (per method)

- **`isCharging`**: Read chargingStatus property
...
|---|---|---|---|
| `getIntProperty` | 3 | composite | Return safe default (null/false/0/empty) |
| `getLongProperty` | 3 | composite | Return safe default (null/false/0/empty) |
| `computeChargeTimeRemaining` | 2 | composite | Return safe default (null/false/0/empty) |
