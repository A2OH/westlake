...
|---|---|---|---|---|---|---|
| `isCanceled` | `boolean isCanceled()` | 5 | partial | moderate | `isLocationEnabled` | `isLocationEnabled(): boolean` |
...
| `CancellationSignal` | 1 | none | Return safe default (null/false/0/empty) |
