# SKILL: android.provider.ContactsContract.Directory

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.provider.ContactsContract.Directory`.
...
Check if these related classes are already shimmed before generating `android.provider.ContactsContract.Directory`:


## Quality Gates

Before marking `android.provider.ContactsContract.Directory` as done:
