# SKILL: android.provider.FontsContract.FontRequestCallback

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.provider.FontsContract.FontRequestCallback`.
...
Check if these related classes are already shimmed before generating `android.provider.FontsContract.FontRequestCallback`:


## Quality Gates

Before marking `android.provider.FontsContract.FontRequestCallback` as done:
