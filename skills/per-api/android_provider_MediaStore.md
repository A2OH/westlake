...
|---|---|---|---|
| `MediaStore` | 3 | composite | throw UnsupportedOperationException |
| `getGeneration` | 3 | composite | Return safe default (null/false/0/empty) |
| `getRequireOriginal` | 3 | composite | Return safe default (null/false/0/empty) |
| `getMediaScannerUri` | 2 | composite | Return safe default (null/false/0/empty) |
