# SKILL: android.provider.SearchRecentSuggestions

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.provider.SearchRecentSuggestions`.
...
Check if these related classes are already shimmed before generating `android.provider.SearchRecentSuggestions`:


## Quality Gates

Before marking `android.provider.SearchRecentSuggestions` as done:
