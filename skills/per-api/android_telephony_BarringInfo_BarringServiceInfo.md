...
|---|---|---|---|
| `isBarred` | 5 | partial | Return safe default (null/false/0/empty) |
| `getBarringType` | 3 | composite | Return safe default (null/false/0/empty) |
| `describeContents` | 1 | none | Store callback, never fire |
| `getConditionalBarringFactor` | 1 | none | Return safe default (null/false/0/empty) |
| `getConditionalBarringTimeSeconds` | 1 | none | Return safe default (null/false/0/empty) |
| `isConditionallyBarred` | 1 | none | Return safe default (null/false/0/empty) |
