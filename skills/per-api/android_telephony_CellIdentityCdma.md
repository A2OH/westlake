...
|---|---|---|---|
| `getNetworkId` | 3 | composite | Return safe default (null/false/0/empty) |
| `getSystemId` | 3 | composite | Return safe default (null/false/0/empty) |
| `getLatitude` | 3 | composite | Return safe default (null/false/0/empty) |
| `getBasestationId` | 3 | composite | Return safe default (null/false/0/empty) |
| `getLongitude` | 2 | composite | Return safe default (null/false/0/empty) |
