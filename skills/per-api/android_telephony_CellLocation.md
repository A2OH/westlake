...
|---|---|---|---|
| `requestLocationUpdate` | 3 | composite | Log warning + no-op |
| `CellLocation` | 3 | composite | Store callback, never fire |
| `getEmpty` | 3 | composite | Return safe default (null/false/0/empty) |
