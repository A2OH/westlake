...
| `getRssnr` | 3 | composite | Return safe default (null/false/0/empty) |
| `getRsrp` | 3 | composite | Return safe default (null/false/0/empty) |
| `getCqi` | 3 | composite | Return safe default (null/false/0/empty) |
| `getDbm` | 3 | composite | Return safe default (null/false/0/empty) |
| `getRsrq` | 2 | composite | Return safe default (null/false/0/empty) |
