...
| `getTransportType` | 3 | composite | Return safe default (null/false/0/empty) |
| `getDomain` | 3 | composite | Return safe default (null/false/0/empty) |
| `getAccessNetworkTechnology` | 3 | composite | Return safe default (null/false/0/empty) |
| `isRoaming` | 2 | composite | Return safe default (null/false/0/empty) |
