...
|---|---|---|---|
| `getDataUsageBytes` | 3 | composite | Return safe default (null/false/0/empty) |
| `getDataUsageTime` | 2 | composite | Return safe default (null/false/0/empty) |
| `getDataLimitBytes` | 2 | composite | Return safe default (null/false/0/empty) |
| `cycleIterator` | 1 | none | throw UnsupportedOperationException |
| `describeContents` | 1 | none | Store callback, never fire |
| `getDataLimitBehavior` | 1 | none | Return safe default (null/false/0/empty) |
