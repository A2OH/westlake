...
| `getFields` | 3 | composite | Return safe default (null/false/0/empty) |
| `getPrefix` | 3 | composite | Return safe default (null/false/0/empty) |
| `getPhoneAccountHandle` | 3 | composite | Return safe default (null/false/0/empty) |
