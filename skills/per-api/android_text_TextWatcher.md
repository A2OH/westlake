# SKILL: android.text.TextWatcher

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.text.TextWatcher`.
...
Check if these related classes are already shimmed before generating `android.text.TextWatcher`:


## Quality Gates

Before marking `android.text.TextWatcher` as done:
