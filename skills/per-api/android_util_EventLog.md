...
|---|---|---|---|---|---|---|
| `getTagName` | `static String getTagName(int)` | 5 | partial | moderate | `getLocalName` | `getLocalName(): string` |
...
|---|---|---|---|
| `getTagCode` | 4 | partial | Return safe default (null/false/0/empty) |
| `readEvents` | 3 | composite | Return safe default (null/false/0/empty) |
| `writeEvent` | 3 | composite | Log warning + no-op |
| `writeEvent` | 3 | composite | Log warning + no-op |
| `writeEvent` | 3 | composite | Log warning + no-op |
| `writeEvent` | 3 | composite | Log warning + no-op |
| `writeEvent` | 3 | composite | Log warning + no-op |
