# SKILL: android.util.IntProperty<T>

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.util.IntProperty<T>`.
...
Check if these related classes are already shimmed before generating `android.util.IntProperty<T>`:


## Quality Gates

Before marking `android.util.IntProperty<T>` as done:
