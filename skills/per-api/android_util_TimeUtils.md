...
|---|---|---|---|---|---|---|
| `getTimeZoneDatabaseVersion` | `static String getTimeZoneDatabaseVersion()` | 5 | partial | moderate | `getTimezoneSync` | `getTimezoneSync(): string` |
...
| `isTimeBetween` | 1 | none | Return safe default (null/false/0/empty) |
