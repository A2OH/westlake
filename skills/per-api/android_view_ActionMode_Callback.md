# SKILL: android.view.ActionMode.Callback

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.ActionMode.Callback`.
...
Check if these related classes are already shimmed before generating `android.view.ActionMode.Callback`:


## Quality Gates

Before marking `android.view.ActionMode.Callback` as done:
