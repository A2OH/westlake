# SKILL: android.view.Choreographer

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.Choreographer`.
...
Check if these related classes are already shimmed before generating `android.view.Choreographer`:
...
Before marking `android.view.Choreographer` as done:
