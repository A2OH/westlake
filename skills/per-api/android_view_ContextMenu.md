# SKILL: android.view.ContextMenu

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.ContextMenu`.
...
Check if these related classes are already shimmed before generating `android.view.ContextMenu`:
...
Before marking `android.view.ContextMenu` as done:
