# SKILL: android.view.DisplayCutout

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.DisplayCutout`.
...
Check if these related classes are already shimmed before generating `android.view.DisplayCutout`:
...
Before marking `android.view.DisplayCutout` as done:
