# SKILL: android.view.Display.HdrCapabilities

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.Display.HdrCapabilities`.
...
Check if these related classes are already shimmed before generating `android.view.Display.HdrCapabilities`:


## Quality Gates

Before marking `android.view.Display.HdrCapabilities` as done:
