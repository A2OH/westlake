# SKILL: android.view.DragEvent

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.DragEvent`.
...
Check if these related classes are already shimmed before generating `android.view.DragEvent`:
...
Before marking `android.view.DragEvent` as done:
