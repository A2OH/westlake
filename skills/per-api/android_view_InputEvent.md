# SKILL: android.view.InputEvent

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.InputEvent`.
...
Check if these related classes are already shimmed before generating `android.view.InputEvent`:
...
Before marking `android.view.InputEvent` as done:
