# SKILL: android.view.KeyEvent.DispatcherState

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.KeyEvent.DispatcherState`.
...
Check if these related classes are already shimmed before generating `android.view.KeyEvent.DispatcherState`:


## Quality Gates

Before marking `android.view.KeyEvent.DispatcherState` as done:
