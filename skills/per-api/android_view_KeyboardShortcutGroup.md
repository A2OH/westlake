# SKILL: android.view.KeyboardShortcutGroup

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.KeyboardShortcutGroup`.
...
Check if these related classes are already shimmed before generating `android.view.KeyboardShortcutGroup`:
...
Before marking `android.view.KeyboardShortcutGroup` as done:
