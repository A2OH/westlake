# SKILL: android.view.MotionEvent.PointerCoords

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.MotionEvent.PointerCoords`.
...
Check if these related classes are already shimmed before generating `android.view.MotionEvent.PointerCoords`:


## Quality Gates

Before marking `android.view.MotionEvent.PointerCoords` as done:
