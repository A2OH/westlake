# SKILL: android.view.TouchDelegate

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.TouchDelegate`.
...
Check if these related classes are already shimmed before generating `android.view.TouchDelegate`:
...
Before marking `android.view.TouchDelegate` as done:
