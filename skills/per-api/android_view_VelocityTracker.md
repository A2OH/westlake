# SKILL: android.view.VelocityTracker

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.VelocityTracker`.
...
Check if these related classes are already shimmed before generating `android.view.VelocityTracker`:
...
Before marking `android.view.VelocityTracker` as done:
