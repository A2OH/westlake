# SKILL: android.view.VerifiedInputEvent

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.VerifiedInputEvent`.
...
Check if these related classes are already shimmed before generating `android.view.VerifiedInputEvent`:
...
Before marking `android.view.VerifiedInputEvent` as done:
