# SKILL: android.view.VerifiedKeyEvent

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.VerifiedKeyEvent`.
...
Check if these related classes are already shimmed before generating `android.view.VerifiedKeyEvent`:
...
Before marking `android.view.VerifiedKeyEvent` as done:
