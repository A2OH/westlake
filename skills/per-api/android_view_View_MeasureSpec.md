# SKILL: android.view.View.MeasureSpec

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.View.MeasureSpec`.
...
Check if these related classes are already shimmed before generating `android.view.View.MeasureSpec`:


## Quality Gates

Before marking `android.view.View.MeasureSpec` as done:
