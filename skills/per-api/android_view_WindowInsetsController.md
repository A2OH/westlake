# SKILL: android.view.WindowInsetsController

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.view.WindowInsetsController`.
...
Check if these related classes are already shimmed before generating `android.view.WindowInsetsController`:
...
Before marking `android.view.WindowInsetsController` as done:
