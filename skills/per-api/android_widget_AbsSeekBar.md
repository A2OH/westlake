# SKILL: android.widget.AbsSeekBar

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.AbsSeekBar`.
...
Check if these related classes are already shimmed before generating `android.widget.AbsSeekBar`:
...
Before marking `android.widget.AbsSeekBar` as done:
