# SKILL: android.widget.Adapter

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.Adapter`.
...
Check if these related classes are already shimmed before generating `android.widget.Adapter`:
...
Before marking `android.widget.Adapter` as done:
