# SKILL: android.widget.DatePicker

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.DatePicker`.
...
Check if these related classes are already shimmed before generating `android.widget.DatePicker`:
...
Before marking `android.widget.DatePicker` as done:
