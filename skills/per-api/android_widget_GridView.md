# SKILL: android.widget.GridView

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.GridView`.
...
Check if these related classes are already shimmed before generating `android.widget.GridView`:
...
Before marking `android.widget.GridView` as done:
