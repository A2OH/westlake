# SKILL: android.widget.RadioButton

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.RadioButton`.
...
|---|---|---|---|
| `RadioButton` | 1 | none | Store callback, never fire |
| `RadioButton` | 1 | none | Store callback, never fire |
| `RadioButton` | 1 | none | Store callback, never fire |
| `RadioButton` | 1 | none | Store callback, never fire |
...
Check if these related classes are already shimmed before generating `android.widget.RadioButton`:
...
Before marking `android.widget.RadioButton` as done:
