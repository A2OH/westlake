# SKILL: android.widget.RadioGroup

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.RadioGroup`.
...
Check if these related classes are already shimmed before generating `android.widget.RadioGroup`:
...
Before marking `android.widget.RadioGroup` as done:
