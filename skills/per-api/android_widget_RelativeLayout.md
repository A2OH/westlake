# SKILL: android.widget.RelativeLayout

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.RelativeLayout`.
...
Check if these related classes are already shimmed before generating `android.widget.RelativeLayout`:
...
Before marking `android.widget.RelativeLayout` as done:
