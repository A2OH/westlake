# SKILL: android.widget.RemoteViewsService.RemoteViewsFactory

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.RemoteViewsService.RemoteViewsFactory`.
...
Check if these related classes are already shimmed before generating `android.widget.RemoteViewsService.RemoteViewsFactory`:


## Quality Gates

Before marking `android.widget.RemoteViewsService.RemoteViewsFactory` as done:
