# SKILL: android.widget.SectionIndexer

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.SectionIndexer`.
...
Check if these related classes are already shimmed before generating `android.widget.SectionIndexer`:
...
Before marking `android.widget.SectionIndexer` as done:
