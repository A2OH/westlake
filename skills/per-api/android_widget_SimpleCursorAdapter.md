# SKILL: android.widget.SimpleCursorAdapter

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.SimpleCursorAdapter`.
...
Check if these related classes are already shimmed before generating `android.widget.SimpleCursorAdapter`:
...
Before marking `android.widget.SimpleCursorAdapter` as done:
