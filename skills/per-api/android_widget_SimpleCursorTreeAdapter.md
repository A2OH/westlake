# SKILL: android.widget.SimpleCursorTreeAdapter

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.SimpleCursorTreeAdapter`.
...
Check if these related classes are already shimmed before generating `android.widget.SimpleCursorTreeAdapter`:
...
Before marking `android.widget.SimpleCursorTreeAdapter` as done:
