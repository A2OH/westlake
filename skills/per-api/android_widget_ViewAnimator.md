# SKILL: android.widget.ViewAnimator

> Auto-generated from api_compat.db. Use this as the primary reference when shimming `android.widget.ViewAnimator`.
...
Check if these related classes are already shimmed before generating `android.widget.ViewAnimator`:
...
Before marking `android.widget.ViewAnimator` as done:
