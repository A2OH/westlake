...
// G2.14u (2026-05-07): adapter Parcel.h dropped <binder/IInterface.h> and
// <binder/Parcelable.h> includes — IInterface.h transitively pulls Binder.h
// which would introduce libbinder UND symbols at link time.  Parcel.h only
// uses these as reference types in template SFINAE / Parcelable* parameters,
// so forward declarations are sufficient.
namespace android {
class IInterface;
class Parcelable;
class ParcelableHolder;
}  // namespace android
